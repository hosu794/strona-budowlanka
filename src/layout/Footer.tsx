...
export default function Footer() {
    return (
        <footer className="bg-green-custom">
           ...
           Copyright by Zespół Szkół Nr 1 Mińsk Mazowiecki 2010-2020 | <b>Polityka prywatności</b> | Powered by 
           <a href="www.hosuwebsites.com" target="_blank"><b className="pointer-click"> HOSU</b></a>
           </span>
           </div>
