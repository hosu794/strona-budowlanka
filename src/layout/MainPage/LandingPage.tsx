    ...
    return (
        <main className="flex items-center justify-center h-screen">    
            <div className="h-auto w-screen flex justify-center space-x-10 flex-col-reverse  xl:flex-row">
                    ...
                    <Link to="/posts"><button className="w-1/2 ml-3 md:ml-0 lg:w-3/4 text-white py-4 px-7 text-sm  sm:text-lg lg:text-2xl font-extrabold tracking-wider bg-green rounded-md font-medium mt-5">Aktualności</button></Link>
                    </div>
