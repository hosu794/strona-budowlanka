        ...
        <Layout>
            <div className="min-h-screen flex flex-col justify-center items-center mt-20">
                <div className="flex flex-row space-between pb-20 pt-20 w-8/12 justify-between">
                    ...
                    <div>
                        <p onClick={onClick} className="font-extrabold text-lg cursor-pointer">
                            Powrót
                        </p>
                    </div>
                </div>
                <div className="w-auto flex flex-col w-8/12">
                    ...
                    <p className="uppercase">DROGI UCZNIU ZWRÓĆ SIĘ DO PEDAGOGA SZKOLNEGO GDY:</p>
                    <ul>
                        <li>Czujesz, że nikt Cię nie rozumie, jesteś samotny.</li>
                        <li>Nie potrafisz porozumieć się z nauczycielem, wychowawcą, rodzicem</li>
                        ...
                        <li>
                            Chcesz tak zwyczajnie porozmawiać, podzielić się swoją radością , sukcesem, ciekawymi
                            pomysłami
                        </li>
                    </ul>
                    <p>Przyjdź także z każdą sprawą, z którą sam nie potrafisz sobie poradzić.</p>
                    <p className="uppercase">DROGI RODZICU ZWRÓCIĆ SIĘ DO PEDAGOGA SZKOLNEGO GDY:</p>
                    <ul>
                        <li>Niepokoi Cię zachowanie dziecka</li>
                        <li>Chcesz porozmawiać o dziecku i Twoich z nim relacjach</li>
                        <li>Masz pytania dotyczące wyników w nauce dziecka i jego funkcjonowania w szkole</li>
                    ...
                    <b>mgr Agnieszka Wojda</b> opieka nad uczniami: Liceum, Branżowej Szkoły I Stopnia Branżowej Szkoły
                    I Stopnia Specjalnej
